...
class StellarPayment extends HTMLElement {
    ...
    async loadWallet(walletIdOrUserId) {
        try {
            ...
            const response = await fetch('/api.php/wallet/getWalletDetails', {
                method: 'POST',
                headers: {
            ...
            const userWalletResponse = await fetch(`/api.php/wallet/getUserWallet`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    async sendPayment(event) {
        ...
        try {
            ...
            const response = await fetch('/api.php/wallet/sendPayment', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
